...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260413070521_AddedClassbookings")]
    partial class AddedClassbookings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ClassBooking", b =>
                {
                    ...
                    b.Property<string>("FitnessClassId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("MemberId", "FitnessClassId")
                        .IsUnique();

                    b.ToTable("ClassBookings", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.FitnessClass", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Entities.ClassBooking", b =>
                {
                    b.HasOne("Domain.Entities.FitnessClass", null)
                        .WithMany()
